...
class EditNonProjectCustomerViewParam {
...
class EditNonProjectCustomerView extends StatefulWidget {
  const EditNonProjectCustomerView({
    required this.param,
    super.key,
  });
  ...
  @override
  State<EditNonProjectCustomerView> createState() =>
      _EditNonProjectCustomerViewState();
}

class _EditNonProjectCustomerViewState
    extends State<EditNonProjectCustomerView> {
  void _showBottomFilterDialog(
    BuildContext context,
    String title,
    EditNonProjectCustomerViewModel model, {
